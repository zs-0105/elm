    ...
    <div class="food_container">
                ...
                <transition name="showlist" v-show="category">
                    <section v-show="sortBy == 'food'" class="category_container sort_detail_type">
                        ...
                        <section class="category_right">
                            <ul>
                                <li v-for="(item, index) in categoryDetail" v-show="index" :key="index"
        ...
        <section class="shop_list_container">
            <shop-list :geohash="geohash" :restaurantCategoryId="restaurant_category_id"
                ...
                :confirmSelect="confirmStatus" :supportIds="support_ids" v-if="latitude"></shop-list>
        </section>
    </div>
</template>
