        ...
        <section class="adddetail">
            <form action="" v-on:submit.prevent>
                <section class="ui-padding-block">
                    ...
                    <div class="input-new">
                        <input type="text" placeholder="请填写能够联系到您的手机号" :class="{ verifies: verifyfour }"
                            v-model="telenum" @input="inputThingfour" />
...
import { postAddAddress } from '@/api'
...
export default {
    ...
    computed: {
        ...mapState([
            'userInfo', 'addAddress', 'removeAddress', 'geohash'
        ]),
