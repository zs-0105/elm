                    ...
                    <div v-else class="address_detail_container">
                        ...
                        <div class="address_detail">
                            <span v-if="choosedAddress.tag"
                                :style="{ backgroundColor: iconColor(choosedAddress.tag) }">{{ choosedAddress.tag
                                }}</span>
                ...
                <div class="choose_type_Container" v-if="showPayWay">
                    ...
                    <ul>
                        <li v-for="item in checkoutData.payments" :key="item.id"
                            ...
                            <span>{{ item.name }}<span v-if="!item.is_online_payment">{{ item.description
                            }}</span></span>
...
import { checkout, getAddress, placeOrders, getAddressList } from '@/api'
